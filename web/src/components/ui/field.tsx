...
function FieldLabel({
  ...
  return (
    <Label
      ...
      className={cn(
        'group/field-label peer/field-label has-data-checked:border-foreground/25 has-data-checked:bg-muted dark:has-data-checked:border-foreground/20 dark:has-data-checked:bg-muted flex w-fit gap-2 leading-snug group-data-[disabled=true]/field:opacity-50 has-[>[data-slot=field]]:rounded-lg has-[>[data-slot=field]]:border *:data-[slot=field]:p-2.5',
