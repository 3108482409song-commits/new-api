      ...
      {rows.map((row) => {
        ...
        return (
          <div
            ...
            className={cn(
              'rounded-lg border bg-(--data-table-card-bg,var(--table-row)) px-3 py-2.5 transition-[background-color,border-color] duration-150 data-[state=selected]:[--data-table-card-bg:color-mix(in_oklch,var(--foreground)_6%,var(--table-row))] data-[state=selected]:border-foreground/40',
